<template>
    ...
    >
        ...
        <SidebarCollapsible title="Konten">
            <SidebarCollapsibleItem :href="route('profile.index')" title="Profil" :active="route().current('profile.index')" />
            <SidebarCollapsibleItem :href="route('koruptor.index')" title="Koruptor" :active="route().current('koruptor.index')" />
        </SidebarCollapsible>
